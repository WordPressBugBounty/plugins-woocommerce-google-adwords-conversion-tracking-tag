...
class Documentation {
	...
	private static function get_documentation_path( $key = 'default' ) {
		...
		$documentation_links = [
			'default'                                           => '/docs/pmw/',
			'ab_tasty_account_id'                               => '/docs/pmw/plugin-configuration/ab-tasty',
			...
			'always_send_s2s'                                   => '/docs/pmw/plugin-configuration/general-settings#always-send-server-side-events',
			...
			'bing_capi_token'                                   => '/docs/pmw/plugin-configuration/microsoft-advertising#conversions-api-capi',
			'cogs_resolution_order'                             => '/docs/pmw/plugin-configuration/shop-settings#cogs-resolution-order',
			'custom_thank_you'                                  => '/docs/pmw/troubleshooting/#wc-custom-thank-you',
			'delete_plugin_data'                                => '/docs/pmw/plugin-configuration/general-settings#delete-plugin-data-on-uninstall',
			'disable_tracking_for'                              => '/docs/pmw/plugin-configuration/general-settings#exclude-user-roles-from-tracking',
			...
			'enhanced_link_attribution'                         => '/docs/pmw/plugin-configuration/google-analytics#enhanced-link-attribution',
			...
			'facebook_capi_test_event_code'                     => '/docs/pmw/plugin-configuration/meta#testing',
			'facebook_capi_gateway'                             => '/docs/pmw/troubleshooting#capi-gateway-mirrors-browser-events',
			...
			'facebook_login_id'                                => '/docs/pmw/features/facebook-login-id',
			'facebook_event_setup_tool'                         => '/docs/pmw/troubleshooting#extra-events-caused-by-metas-event-setup-tool-rules',
			'facebook_pixel_id'                                 => '/docs/pmw/plugin-configuration/meta#find-the-pixel-id',
			'facebook_restricted_events'                        => '/docs/pmw/troubleshooting#meta-silently-drops-addtocart-initiatecheckout-and-purchase-restricted-business-category',
			...
			'google_business_vertical'                          => '/docs/pmw/plugin-configuration/shop-settings#google-business-vertical',
			'google_consent_mode'                               => '/docs/pmw/consent-management/google#google-consent-mode',
			'google_enhanced_conversions'                       => '/docs/pmw/plugin-configuration/google#enhanced-conversions',
			...
			'hyros_product_hash'                                => '/docs/pmw/plugin-configuration/hyros',
			'hyros_application_tag'                             => '/docs/pmw/plugin-configuration/hyros#application-tag',
			...
			'criteo_account_id'                                 => '/docs/pmw/plugin-configuration/criteo',
			'criteo_advanced_matching'                          => '/docs/pmw/plugin-configuration/criteo#advanced-matching',
			'nextdoor_pixel_id'                                 => '/docs/pmw/plugin-configuration/nextdoor',
			'nextdoor_advanced_matching'                        => '/docs/pmw/plugin-configuration/nextdoor#advanced-matching',
			'nextdoor_capi_token'                               => '/docs/pmw/plugin-configuration/nextdoor#conversion-api-capi',
			'nextdoor_capi_test_event_code'                     => '/docs/pmw/plugin-configuration/nextdoor#testing',
			'groundtruth_gtid'                                  => '/docs/pmw/plugin-configuration/groundtruth',
			'mixpanel_project_token'                            => '/docs/pmw/plugin-configuration/mixpanel',
			'mixpanel_data_residency'                           => '/docs/pmw/plugin-configuration/mixpanel#data-residency',
			'mixpanel_ingestion_api'                            => '/docs/pmw/plugin-configuration/mixpanel#ingestion-api',
			'mixpanel_session_recording'                        => '/docs/pmw/plugin-configuration/mixpanel#session-replay-and-heatmaps',
			'mixpanel_autocapture'                              => '/docs/pmw/plugin-configuration/mixpanel#autocapture',
			'mixpanel_user_identification'                      => '/docs/pmw/plugin-configuration/mixpanel#user-identification',
			'klaviyo_public_api_key'                            => '/docs/pmw/plugin-configuration/klaviyo',
			'klaviyo_coexistence'                               => '/docs/pmw/plugin-configuration/klaviyo#coexistence-with-the-klaviyo-plugin',
			'klaviyo_identify_customers'                        => '/docs/pmw/plugin-configuration/klaviyo#customer-identification',
			'klaviyo_events_api_token'                          => '/docs/pmw/plugin-configuration/klaviyo#events-api',
			'klaviyo_integration_disconnected'                  => '/docs/pmw/plugin-configuration/klaviyo#klaviyo-is-not-receiving-orders',
			...
			'linkedin_partner_id'                               => '/docs/pmw/plugin-configuration/linkedin#basic-setup',
			...
			'ltv_recalculation'                                 => '/docs/pmw/plugin-configuration/shop-settings#lifetime-value-calculation-recalculation',
			...
			'optimizely_project_id'                             => '/docs/pmw/plugin-configuration/optimizely',
			...
			'product_identifier'                                => '/docs/pmw/plugin-configuration/shop-settings#product-identifier',
			'reddit_advanced_matching'                          => '/docs/pmw/plugin-configuration/reddit#advanced-matching',
			'reddit_advertiser_id'                              => '/docs/pmw/plugin-configuration/reddit#basic-setup',
			...
			'openai_advanced_matching'                          => '/docs/pmw/plugin-configuration/openai#advanced-matching',
			'openai_capi_token'                                 => '/docs/pmw/plugin-configuration/openai#conversions-api-capi',
			'openai_pixel_id'                                   => '/docs/pmw/plugin-configuration/openai#setup-instruction',
			...
			'ssp'                                               => '/docs/pmw/server-side-proxy/overview',
			...
			'triple_whale'                                      => '/docs/pmw/plugin-configuration/triple-whale',
